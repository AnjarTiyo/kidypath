...
CREATE TYPE "public"."attendance_status" AS ENUM('present', 'sick', 'permission');--> statement-breakpoint
...
CREATE TYPE "public"."mood" AS ENUM('bahagia', 'sedih', 'marah', 'takut', 'jijik');--> statement-breakpoint
...
CREATE TABLE "users" (
	...
	"role" "user_role",
	"is_curriculum_coordinator" boolean DEFAULT false,
	"created_at" timestamp with time zone DEFAULT now(),
	"updated_at" timestamp with time zone DEFAULT now(),
...
ALTER TABLE "assessment_items" ADD CONSTRAINT "assessment_items_daily_assessment_id_daily_assessments_id_fk" FOREIGN KEY ("daily_assessment_id") REFERENCES "public"."daily_assessments"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "assessment_items" ADD CONSTRAINT "assessment_items_scope_id_development_scopes_id_fk" FOREIGN KEY ("scope_id") REFERENCES "public"."development_scopes"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "assessment_items" ADD CONSTRAINT "assessment_items_objective_id_learning_objectives_id_fk" FOREIGN KEY ("objective_id") REFERENCES "public"."learning_objectives"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "attendances" ADD CONSTRAINT "attendances_classroom_id_classrooms_id_fk" FOREIGN KEY ("classroom_id") REFERENCES "public"."classrooms"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "daily_assessments" ADD CONSTRAINT "daily_assessments_classroom_id_classrooms_id_fk" FOREIGN KEY ("classroom_id") REFERENCES "public"."classrooms"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "daily_assessments" ADD CONSTRAINT "daily_assessments_created_by_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
