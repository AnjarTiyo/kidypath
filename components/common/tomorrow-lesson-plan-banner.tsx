...
import { type TodayStatusItem } from "@/lib/hooks/use-today-daily-status"
  ...
  return (
    <div className="flex items-center gap-3 py-2.5 first:pt-0 last:pb-0">
      ...
      <Button
        ...
        variant="outline"
        onClick={onAction}
        className="flex-shrink-0 border-amber-300 bg-white text-amber-800 hover:bg-amber-100 hover:text-amber-900"
      >
        {actionLabel}
      </Button>
    </div>
...
export function OutstandingTasksBanner({
  ...
  const hasAnyOutstanding = hasTomorrowLessonPlan || hasTodayOutstanding
